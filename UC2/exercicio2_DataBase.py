...
class Banco_do_Jurandi:
    def __init__(self, nome_banco='Banco_do_Jurandi'):
...
# Programa principal para testar a classe ContaBancaria e Banco_do_Jurandi
banco_de_dados = Banco_do_Jurandi()

conta1 = ContaBancaria("Ciliro", "12345", banco_de_dados=banco_de_dados)
conta2 = ContaBancaria("Joaquina", "54321", 1000, banco_de_dados=banco_de_dados)
